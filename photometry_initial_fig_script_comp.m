    ...
    f = figure
        ...
        % Obtain premature traces
            ...
            for q = 1:size(photometryStruct(i).restart_timestamps_animal1, 1) % i is the index for the photometry struct, q is the index for the trial of that session
                photosignal_restart_index = find(photometryStruct(i).deltafoverf_normalized(:, 2) >= (photometryStruct(i).restart_timestamps_animal1(q, 1) - 1) & photometryStruct(i).deltafoverf_normalized(:, 2) < (photometryStruct(i).restart_timestamps_animal1(q, 1) + 1));
                ...
                photosignal_restart_fiber1(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_restart_index, 3);
                photosignal_restart_fiber2(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_restart_index, 4);
            ...
            for q = 1:size(photometryStruct(i).restart_timestamps_animal2, 1) % i is the index for the photometry struct, q is the index for the trial of that session
                photosignal_restart_index = find(photometryStruct(i).deltafoverf_normalized(:, 2) >= (photometryStruct(i).restart_timestamps_animal2(q, 1) - 1) & photometryStruct(i).deltafoverf_normalized(:, 2) < (photometryStruct(i).restart_timestamps_animal2(q, 1) + 1));
                    if size(photosignal_restart_index, 1) > 80
                        photosignal_restart_index = photosignal_restart_index(1:80, 1);
                    elseif size(photosignal_restart_index, 1) < 80
                ...
                photosignal_restart_fiber3(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_restart_index, 5);
                photosignal_restart_fiber4(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_restart_index, 6);
        ...
        % Obtain start of trial traces
            ...
            for q = 1:size(photometryStruct(i).trial_start_timestamps_animal1, 1) % i is the index for the photometry struct, q is the index for the trial of that session
                photosignal_trial_start_index = find(photometryStruct(i).deltafoverf_normalized(:, 2) >= (photometryStruct(i).trial_start_timestamps_animal1(q, 1) - 1) & photometryStruct(i).deltafoverf_normalized(:, 2) < (photometryStruct(i).trial_start_timestamps_animal1(q, 1) + 1));
                ...
                photosignal_trial_start_fiber1(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_trial_start_index, 3);
                photosignal_trial_start_fiber2(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_trial_start_index, 4);
            ...
            for q = 1:size(photometryStruct(i).trial_start_timestamps_animal2, 1) % i is the index for the photometry struct, q is the index for the trial of that session
                photosignal_trial_start_index = find(photometryStruct(i).deltafoverf_normalized(:, 2) >= (photometryStruct(i).trial_start_timestamps_animal2(q, 1) - 1) & photometryStruct(i).deltafoverf_normalized(:, 2) < (photometryStruct(i).trial_start_timestamps_animal2(q, 1) + 1));
                    if size(photosignal_trial_start_index, 1) > 80
                        photosignal_trial_start_index = photosignal_trial_start_index(1:80, 1);
                    elseif size(photosignal_trial_start_index, 1) < 80
                ...
                photosignal_trial_start_fiber3(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_trial_start_index, 5);
                photosignal_trial_start_fiber4(q, :) = photometryStruct(i).deltafoverf_normalized(photosignal_trial_start_index, 6);
...
figname = strcat('InitialFig_', photometryStruct(i).session_date, '_', photometryStruct(i).session_time, '_', photometryStruct(i).animalID_1, '.png');
...
figname = strcat('InitialFig_', photometryStruct(i).session_date, '_', photometryStruct(i).session_time, '_', photometryStruct(i).animalID_2, '.png');
saveas(gcf, fullfile(filepath, figname));
close all
