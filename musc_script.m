...
folder = "C:\Users\sarfe\Box\Sarah_shared_folder\Filtering Paper\figures\Muscimol Figure\Extra Stuff\Muscimol_Data";
...
h = waitbar(0,'Analysis in progress...');
    ...
    for i = 1:num_files(1, 2)
        ...
        try
            output(i + num_files(1, 1)) = musc_analysis_funct(files(i).name, file_array{i, 2}, file_array{i, 11}, file_array{i, 12}, file_array{i, 1}, 'true');
        catch e
