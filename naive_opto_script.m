...
%folder = "C:\Users\sarfe\Desktop\Data_Analysis\June2024_Opto_Naive";
%folder = "C:\Users\sarfe\Desktop\Data_Analysis\Aug2024_Analysis";
folder = "C:\Users\sarfe\Box\Documents\Go_NoGo\March2025\NonAuditory_Opto\Inhibitory_Raw_Data";
...
h = waitbar(0,'Analysis in progress...');
    ...
    for i = 1:num_files(1, 2)
        ...
        try
            output(i + num_files(1, 1)) = naive_opto_analysis_funct(files(i).name, file_array{i, 2}, file_array{i, 11}, file_array{i, 12}, file_array{i, 1}, 'true');
        catch e
