function [output] = go_nogo_photo_analysis_funct(filename, num, phase, day, date, cutoff_setting); %filename is the "c:\path", '9-7-21' and 'number'
% Photometry analysis for go no-go task Dec 2024
