...
folder = "C:\Users\sarfe\Box\Documents\Go_NoGo\Jan2025_Summary_So_Far\Muscimol\Muscimol_Data";
...
h = waitbar(0,'Analysis in progress...');
    ...
    for i = 1:num_files(1, 2)
        ...
        try
            output(i + num_files(1, 1)) = go_nogo_analysis_funct(files(i).name, file_array{i, 2}, file_array{i, 11}, file_array{i, 12}, file_array{i, 1}, 'false');
        catch e
