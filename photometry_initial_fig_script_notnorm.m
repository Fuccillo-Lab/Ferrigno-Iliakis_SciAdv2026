% Makes initial photometry figure for photometry session data (not zscored)
...
figure(i)
    ...
    ylabel('\DeltaF/F');
    title(strcat(photometryStruct(i).Fiber1_ID, ' debleach'), 'Interpreter', 'none');
    p = p + 1;
    
    subplot(6, 4, p);  % Second subplot in row
    plot(photometryStruct(i).deltafoverf_debleached(1:100:end, 4));
    title(strcat(photometryStruct(i).Fiber2_ID, ' debleach'), 'Interpreter', 'none');
    p = p + 1;
    
    subplot(6, 4, p);  % Third subplot in row
    plot(photometryStruct(i).deltafoverf_debleached(1:100:end, 5));
    title(strcat(photometryStruct(i).Fiber3_ID, ' debleach'), 'Interpreter', 'none');
    p = p + 1;
    
    subplot(6, 4, p);  % Fourth subplot in row
    plot(photometryStruct(i).deltafoverf_debleached(1:100:end, 6));
    title(strcat(photometryStruct(i).Fiber4_ID, ' debleach'), 'Interpreter', 'none');
    p = p + 1;
    ...
    % Plot Hit traces
        ...
        for q = 1:size(photometryStruct(i).hit_go_sound_timestamps_animal1, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            ...
            photosignal_hit_go_sound_fiber1(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_hit_go_sound_index, 3);
            photosignal_hit_go_sound_fiber2(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_hit_go_sound_index, 4);
        ...
        for q = 1:size(photometryStruct(i).hit_go_sound_timestamps_animal2, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            ...
            photosignal_hit_go_sound_fiber3(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_hit_go_sound_index, 5);
            photosignal_hit_go_sound_fiber4(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_hit_go_sound_index, 6);
    ...
    % Plot Miss traces
        ...
        for q = 1:size(photometryStruct(i).miss_go_sound_timestamps_animal1, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            photosignal_miss_go_sound_index = find(photometryStruct(i).deltafoverf_debleached(:, 2) >= (photometryStruct(i).miss_go_sound_timestamps_animal1(q, 1) - 1) & photometryStruct(i).deltafoverf_debleached(:, 2) < (photometryStruct(i).miss_go_sound_timestamps_animal1(q, 1) + 1));
            ...
            photosignal_miss_go_sound_fiber1(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_miss_go_sound_index, 3);
            photosignal_miss_go_sound_fiber2(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_miss_go_sound_index, 4);
        ...
        for q = 1:size(photometryStruct(i).miss_go_sound_timestamps_animal2, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            photosignal_miss_go_sound_index = find(photometryStruct(i).deltafoverf_debleached(:, 2) >= (photometryStruct(i).miss_go_sound_timestamps_animal2(q, 1) - 1) & photometryStruct(i).deltafoverf_debleached(:, 2) < (photometryStruct(i).miss_go_sound_timestamps_animal2(q, 1) + 1));
                if size(photosignal_miss_go_sound_index, 1) > 80
                    photosignal_miss_go_sound_index = photosignal_miss_go_sound_index(1:80, 1);
                elseif size(photosignal_miss_go_sound_index, 1) < 80
            ...
            photosignal_miss_go_sound_fiber3(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_miss_go_sound_index, 5);
            photosignal_miss_go_sound_fiber4(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_miss_go_sound_index, 6);
    ...
    % Plot CR traces
        ...
        for q = 1:size(photometryStruct(i).cr_nogo_sound_timestamps_animal1, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            ...
            photosignal_cr_nogo_sound_fiber1(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_cr_nogo_sound_index, 3);
            photosignal_cr_nogo_sound_fiber2(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_cr_nogo_sound_index, 4);
        ...
        for q = 1:size(photometryStruct(i).cr_nogo_sound_timestamps_animal2, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            ...
            photosignal_cr_nogo_sound_fiber3(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_cr_nogo_sound_index, 5);
            photosignal_cr_nogo_sound_fiber4(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_cr_nogo_sound_index, 6);
    ...
    % Plot FA traces
        ...
        for q = 1:size(photometryStruct(i).fa_nogo_sound_timestamps_animal1, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            photosignal_fa_nogo_sound_index = find(photometryStruct(i).deltafoverf_debleached(:, 2) >= (photometryStruct(i).fa_nogo_sound_timestamps_animal1(q, 1) - 1) & photometryStruct(i).deltafoverf_debleached(:, 2) < (photometryStruct(i).fa_nogo_sound_timestamps_animal1(q, 1) + 1));
            ...
            photosignal_fa_nogo_sound_fiber1(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_fa_nogo_sound_index, 3);
            photosignal_fa_nogo_sound_fiber2(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_fa_nogo_sound_index, 4);
        ...
        for q = 1:size(photometryStruct(i).fa_nogo_sound_timestamps_animal2, 1) % i is the index for the photometry struct, q is the index for the trial of that session
            photosignal_fa_nogo_sound_index = find(photometryStruct(i).deltafoverf_debleached(:, 2) >= (photometryStruct(i).fa_nogo_sound_timestamps_animal2(q, 1) - 1) & photometryStruct(i).deltafoverf_debleached(:, 2) < (photometryStruct(i).fa_nogo_sound_timestamps_animal2(q, 1) + 1));
                if size(photosignal_fa_nogo_sound_index, 1) > 80
                    photosignal_fa_nogo_sound_index = photosignal_fa_nogo_sound_index(1:80, 1);
                elseif size(photosignal_fa_nogo_sound_index, 1) < 80
            ...
            photosignal_fa_nogo_sound_fiber3(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_fa_nogo_sound_index, 5);
            photosignal_fa_nogo_sound_fiber4(q, :) = photometryStruct(i).deltafoverf_debleached(photosignal_fa_nogo_sound_index, 6);
...
if photometryStruct(i).animalID_1 ~= "n/a" & photometryStruct(i).animalID_2 ~= "n/a"
	figname = strcat('InitialFig_notnorm_', photometryStruct(i).session_date, '_', photometryStruct(i).session_time, '_', photometryStruct(i).animalID_1, '_', photometryStruct(i).animalID_2, '.fig');


elseif photometryStruct(i).animalID_1 ~= "n/a"
	figname = strcat('InitialFig_notnorm_', photometryStruct(i).session_date, '_', photometryStruct(i).session_time, '_', photometryStruct(i).animalID_1,  '.fig');

elseif photometryStruct(i).animalID_2 ~= "n/a"
	figname = strcat('InitialFig_notnorm_', photometryStruct(i).session_date, '_', photometryStruct(i).session_time, '_', photometryStruct(i).animalID_2,  '.fig');
